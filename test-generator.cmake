...
function(CreateTests) # TEST_LIST TEST_DIR TEST_TEMPLATE_NAME TEST_LIBRARY
    ...
    if(NOT DEFINED TEST_GENERATOR_ROOT_DIR)
        if(IS_DIRECTORY "${PROJECT_SOURCE_DIR}/cmake-test-generator")
            ...
            set(TEST_GENERATOR_ROOT_DIR "" PARENT_SCOPE)
        endif()
    endif()
...
#    message(STATUS "${CREATE_TESTS_TEST_DIR}")
#    message(STATUS "${CREATE_TESTS_TEST_TEMPLATE_NAME}")
#    message(STATUS "${CREATE_TESTS_TEST_LIBRARY}")
#    message(STATUS "${CREATE_TESTS_TEST_LIST}")
